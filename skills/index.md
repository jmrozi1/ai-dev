...
| `orchestrator` | ChatGPT coordinating Claude/Coxswain orchestrators through broad outcome mandates, delegated decision authority, durable intent, evidence-based oversight, and genuine escalations; never directly tasking executors. | `skills/chatgpt/orchestrator/SKILL.md` |
